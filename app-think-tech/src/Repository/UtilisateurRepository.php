...
class UtilisateurRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
    ...
    */
    ...
    public function getAllFormateursByKeyword($keyword){
        $q = $this->createQueryBuilder('u');
        return $q
        ->where('u.nom = :nom')
        ->setParameter('nom', $keyword)
       /* ->orWhere($q->e)
        ->setParameter('prenom', $keyword)
        ->orWhere('u.cin LIKE :cin')
        ->setParameter('cin', $keyword)*/
    ...
    public function getAllApprenantsByKeyword($keyword){
        $q = $this->createQueryBuilder('u');
        return $q
        ->where('u.nom = :nom')
        ->setParameter('nom', $keyword)
